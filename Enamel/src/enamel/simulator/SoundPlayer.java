...
public class SoundPlayer 
{
	...
	/*
	 * This method plays the scenario file if the scenario file exists in the same folder as the project,
	 * and that the scenario file is being accessed by its file name.
	 */
	...
	/*
	 * This method plays the scenario file by looking for it through the specified file directory path.
	 */
	public void startDir (String dirName) 
	{
		try
		{
		...
		catch (Exception e)
		{
			errorLog ("Exception error: " + e.toString(), "Expected the directory path of the scenario file to"
					+ " a file exists in the project folder. \n Could not find directory to path: " + dirName 
